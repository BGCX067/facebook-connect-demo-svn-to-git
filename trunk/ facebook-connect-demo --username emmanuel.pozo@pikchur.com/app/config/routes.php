 ...
 */
	...
	/*Router::connect ('(?!login|signup|logout|index|search|profile|oauth|messages|\s)(.*)', array('controller'=>'users', 'action'=>'index'));
	...
	Router::connect('/test/:action/*', array('controller' => 'test'));
	
	Router::connect('/:action/*', array('controller' => 'website'));
